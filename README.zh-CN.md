...
- **5 大 AI Agent** — Claude Code、Codex、Cursor Agent、Qoder CLI、Gemini CLI，按需选用，也可以同时使用
...
- **Qoder CLI**: [Qoder CLI](https://qoder.com) 已安装（`curl -fsSL https://qoder.com/install | bash`）
