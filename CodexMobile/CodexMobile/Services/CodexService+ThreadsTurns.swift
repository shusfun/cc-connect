...
extension CodexService {
    ...
    func listThreads(limit: Int? = nil) async throws {
        ...
        _ = limit
        _ = try await syncPrivateCatalog()
    ...
    private func startThreadImpl(
        ...
        let includesServiceTier = explicitServiceTier != nil
        ...
        while true {
            ...
            do {
                ...
                presentUnsupportedServiceTierUpgradeIfNeeded(
                    error,
...
extension CodexService {
    ...
    func ensureThreadResumed(
        ...
        let task = Task<CodexThread?, Error> { @MainActor in
            ...
            let didRequestExcludedTurns = params["excludeTurns"] != nil
            let response: RPCMessage
            do {
                ...
                presentUnsupportedTurnPaginationUpgradeIfNeeded(error)
                throw error
            }
            try validateAppliedAccessConfiguration(
                in: response,
                    ...
                    if didRequestExcludedTurns,
                       threadObject["turns"]?.arrayValue?.isEmpty == false {
                        ...
                        throw CodexServiceError.invalidResponse(
                            "thread/resume ignored excludeTurns; update the Mac App and Codex"
                        )
                    }
    ...
    // Reads the latest turn page from the current app-server contract.
    func readThreadTurnStateSnapshot(threadId: String) async throws -> (
        ...
        do {
            ...
            presentUnsupportedTurnPaginationUpgradeIfNeeded(
                error,
                attemptedMethod: "thread/turns/list"
            )
            throw error
        }
        ...
        // The Desktop mirror can carry a fresher active turn id than the bounded canonical page.
