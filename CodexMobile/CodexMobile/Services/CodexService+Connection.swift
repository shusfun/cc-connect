...
extension CodexService {
    ...
    func disconnect(preserveReconnectIntent: Bool = false) async {
        ...
        privateSyncNegotiationTask?.cancel()
    ...
    func initializeSession() async throws {
        ...
        // The bundled bridge requires the current capability-aware app-server handshake.
        ...
        do {
            ...
            try validateTurnPaginationRuntimeVersion(initializeResponse)
