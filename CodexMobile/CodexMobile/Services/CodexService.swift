...
// Depends on: Foundation, Observation, RPCMessage, CodexThread, CodexMessage
...
final class CodexService {
    ...
    @ObservationIgnored var privateSyncProtocolVersion: Int?
    @ObservationIgnored var privateSyncNegotiationTask: Task<Int, Error>?
