...
private let minimumBridgePackageUpdateCommand: String? = nil
private let forcedBridgeUpgradeFromVersion = "1.3.8"
private let forcedBridgeUpgradeTargetVersion = "1.3.9"
private let forcedBridgeUpgradeCommand: String? = nil
...
extension CodexService {
    ...
    // Prompts for a Mac App upgrade once per session when its bundled Bridge is incompatible.
    ...
    // Surfaces a softer bundled Bridge update prompt without overriding compatibility failures.
