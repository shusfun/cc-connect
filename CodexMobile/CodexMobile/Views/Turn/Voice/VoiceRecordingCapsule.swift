...
private struct ScrollingWaveformLane: View {
    ...
    private let sampleInterval: TimeInterval = VoiceRecordingManager.meterWindowSeconds
...
private struct VoiceRecordingCapsulePreview: View {
    ...
    private let timer = Timer.publish(
        every: VoiceRecordingManager.meterWindowSeconds,
        on: .main,
        in: .common
    ).autoconnect()
    ...
    var body: some View {
        ...
        .onReceive(timer) { _ in
            ...
            elapsed += VoiceRecordingManager.meterWindowSeconds
